          ...
          >
            {props.links.map((link) => {
              return (
                <a
                  key={link.label}
                  className={`hover:text-gray-900 hover:bg-gray-200 flex items-center p-2 my-2 transition-colors dark:hover:text-white dark:hover:bg-gray-600 duration-200 ${
